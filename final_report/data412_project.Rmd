...
include more advanced methods such as regressions or hypotheses tests. 

To expand on the existing literature, we will use logistic multiple regression
models to explore the relationship between demographic factors such as subject
or officer race and the severity of a given use of force. By including all of
...
In DC, specifically, previous research has
used this research to establish that the majority of citizen-police
interactions involve Black residents and that these individuals were much
