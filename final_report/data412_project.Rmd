...
scattered and often non-consistent. The Washington Post's database, for example,
relies on local news reports (Nix 2022). 
...
racialized policing not only in terms of fatal violence, but in terms of the
