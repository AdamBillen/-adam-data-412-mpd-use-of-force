...
```
DC specific officer/subject relationships
```{r}
...
row_names_ind <- c("White subject", "Black subject", "Hispanic subject", "Asian subject")
col_names_ind <- c("White officer", "Black officer", "Hispanic officer")

data_df_ind <- as.data.frame(matrix_data_ind)
